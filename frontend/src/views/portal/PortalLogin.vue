<template>
  <div class="login-page">
    <div class="login-card">
      ...
      <p class="login-sub">Acompanhe seus veículos, orçamentos e serviços</p>
      ...
      <div class="login-portal-link">
        <RouterLink to="/login">Sou da equipe AutoTrack →</RouterLink>
      </div>
    </div>
  </div>
</template>
...
const submit = async () => {
  ...
  try {
    const { data } = await portalApi.post('/login', { email: email.value, password: password.value })
